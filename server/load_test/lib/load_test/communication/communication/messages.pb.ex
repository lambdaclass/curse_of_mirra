...
defmodule LoadTest.Communication.Proto.Config do
  ...
  field(:characters, 1, type: LoadTest.Communication.Proto.GameCharactersConfig)
  field(:effects, 2, type: LoadTest.Communication.Proto.GameEffectsConfig)
  field(:game, 3, type: LoadTest.Communication.Proto.GameStateConfig)
  field(:loots, 4, type: LoadTest.Communication.Proto.GameLootsConfig)
  field(:projectiles, 5, type: LoadTest.Communication.Proto.GameProjectilesConfig)
  field(:skills, 6, type: LoadTest.Communication.Proto.GameSkillsConfig)
end

defmodule LoadTest.Communication.Proto.GameCharactersConfig do
  @moduledoc false
...
defmodule LoadTest.Communication.Proto.GameEffectsConfig do
  @moduledoc false

  use Protobuf, syntax: :proto3, protoc_gen_elixir_version: "0.12.0"

  field(:effects, 1, repeated: true, type: LoadTest.Communication.Proto.GameEffect)
end
...
defmodule LoadTest.Communication.Proto.GameLootsConfig do
  @moduledoc false

  use Protobuf, syntax: :proto3, protoc_gen_elixir_version: "0.12.0"

  field(:loots, 1, repeated: true, type: LoadTest.Communication.Proto.GameLoot)
end

defmodule LoadTest.Communication.Proto.GameProjectilesConfig do
  @moduledoc false
  ...
  field(:projectiles_config, 1,
    repeated: true,
    type: LoadTest.Communication.Proto.GameProjectile,
    json_name: "projectilesConfig"
  )
end

defmodule LoadTest.Communication.Proto.GameSkillsConfig do
  @moduledoc false

  use Protobuf, syntax: :proto3, protoc_gen_elixir_version: "0.12.0"

  field(:skills, 1, repeated: true, type: LoadTest.Communication.Proto.GameSkill)
end
