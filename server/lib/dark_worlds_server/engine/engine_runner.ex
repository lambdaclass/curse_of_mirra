defmodule DarkWorldsServer.Engine.EngineRunner do
  ...
  defp broadcast_game_state(topic, game_state) do
    ...
    |> transform_state_to_myrra_state()

    reply_map = %{
      players: game_state.players,
      projectiles: game_state.projectiles,
      killfeed: game_state.killfeed,
      player_timestamp: DateTime.utc_now() |> DateTime.to_unix(:millisecond),
    ...
    encoded_game_state = Communication.game_update!(reply_map)

    Phoenix.PubSub.broadcast(
      DarkWorldsServer.PubSub,
      topic,
      {:game_state_v2, encoded_game_state}
    )
  end
