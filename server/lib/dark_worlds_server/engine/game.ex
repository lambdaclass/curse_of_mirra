defmodule DarkWorldsServer.Engine.Game do
  ...
  def move_player_to_relative_position(game_state, player_id, relative_position), do: LambdaGameEngine.move_player_to_relative_position(game_state, player_id, relative_position)
  def move_with_joystick(game_state,player_id, x, y), do: LambdaGameEngine.move_with_joystick(game_state,player_id, x, y)
