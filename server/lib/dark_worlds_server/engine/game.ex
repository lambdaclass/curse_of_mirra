defmodule DarkWorldsServer.Engine.Game do
  ...
  def teleport_player_to_coordinates(_game_state, _player_id, _relative_position), do: :erlang.nif_error(:nif_not_loaded)
  ...
  def neon_crash(_a, _b, _c), do: :erlang.nif_error(:nif_not_loaded)
