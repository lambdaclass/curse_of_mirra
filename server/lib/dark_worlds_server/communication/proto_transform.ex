defmodule DarkWorldsServer.Communication.ProtoTransform do
  ...
  defp effect_encode({:slowed, %{ends_at: ends_at}}), do: {5, ends_at}
  defp effect_encode({:leaping, %{ends_at: ends_at}}), do: {6, ends_at}
  defp effect_encode({:out_of_area, %{ends_at: ends_at}}), do: {7, ends_at}
  defp effect_encode({:elnar_mark, %{ends_at: ends_at}}), do: {8, ends_at}
  defp effect_encode({:yugen_mark, %{ends_at: ends_at}}), do: {9, ends_at}
