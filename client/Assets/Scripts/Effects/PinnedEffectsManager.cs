...
{
    [SerializeField]
    private List<PlacementHolderTransformPair> placeholder_transform_pairs = null;
    ...
    public Transform GetTransformByPlaceholder(PlacementHolder look_up_placementholder)
    {
        ...
        look_up_transform = placeholder_transform_pairs
            .FirstOrDefault(x => x.placement_holder == look_up_placementholder)
            ?.look_up_transform;
        return look_up_transform;
    }
}
...
public class PlacementHolderTransformPair
{
    ...
    [SerializeField]
    public Transform look_up_transform = null;
}
